...
export const loadDatasetData = createThunkAction('layer-card/loadDatasetData', (params) => (dispatch, getState) => {
  if (params && params.id) {
...
export const loadWidgetData = createThunkAction('layer-card/loadWidgetData', (id) => (dispatch) => {
  if (id) {
    fetchWidget(id).then((response) => dispatch(setWidget(response)));
  } else {
