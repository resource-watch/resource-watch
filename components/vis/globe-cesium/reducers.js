...
export default {
  [actions.setShapesCreated]: (state, { payload }) => ({ ...state, shapesCreated: payload }),
  [actions.setPosition]: (state, { payload }) => ({ ...state, position: payload }),
  [actions.setInitialPosition]: (state, { payload }) => ({ ...state, initialPosition: payload, position: payload }),
