...
export default {
  [actions.setSimilarDatasetsLoading]: (state, { payload }) => ({ ...state, loading: payload, error: null }),
  [actions.setSimilarDatasetsError]: (state, { payload }) => ({ ...state, loading: false, error: payload }),
