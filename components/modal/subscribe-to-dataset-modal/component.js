...
//     this.toggleSubscribeModalPreview = this.toggleSubscribeModalPreview.bind(this);
...
//               <Spinner isLoading={loadingAreaOptions || loading || loadingUserAreas} className="-light -small" />
...
//               Subscribe
//             </button>
//             <button className="c-btn -secondary" onClick={this.toggleSubscribeModalPreview}>
//               Preview
//             </button>
