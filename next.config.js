    ...
    webpack: originalConfig => {
      ...
      config.plugins.push(
        new webpack.DefinePlugin({
          ...
          "process.env.BASEMAP_TILE_URL": JSON.stringify(
            process.env.BASEMAP_TILE_URL
          ),
          "process.env.CALLBACK_URL": JSON.stringify(process.env.CALLBACK_URL),
          "process.env.CONTROL_TOWER_URL": JSON.stringify(
          ...
          "process.env.STATIC_SERVER_URL": JSON.stringify(
            process.env.STATIC_SERVER_URL
          ),
          "process.env.ADD_SEARCH_KEY": JSON.stringify(
            process.env.ADD_SEARCH_KEY
          ),
          "process.env.TRANSIFEX_LIVE_API": JSON.stringify(
            process.env.TRANSIFEX_LIVE_API
          ),
          "process.env.BING_MAPS_API_KEY": JSON.stringify(
